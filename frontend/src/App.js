        ...
        <Row className="service-cards text-center">
          <Col md={6} className="mb-4">
            <div id="cardSection1">
              <Card>
                <Card.Body>
                  <Card.Title className='ps-5 pb-4' style={{ textAlign: 'center', textDecoration: 'underline' }}>
          ...
          <Col md={6} className="mb-4 pt-5">
            <div id="cardSection2">
              <Card>
                <Card.Body>
                  <Card.Title className='ps-5 pb-4' style={{ textAlign: 'center', textDecoration: 'underline' }}>
                    Your Trusted Property Management Partner</Card.Title>
                  <Card.Text>
